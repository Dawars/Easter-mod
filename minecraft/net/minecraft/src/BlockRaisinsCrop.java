...
public class BlockRaisinsCrop extends BlockFlower implements ITextureProvider
{
        protected BlockRaisinsCrop(int par1, int par2)
        {
            super(par1, par2);
        ...
        public ArrayList<ItemStack> getBlockDropped(World world, int x, int y, int z, int metadata, int fortune)
        {
            ...
            if (metadata == 7)
            {
                ret.add(new ItemStack(EasterItems.Raisins));
            }
        ...
        {
            return par1 == 7 ? EasterItems.Raisins.shiftedIndex : -1;
        }
