...
public class EasterItemPickaxe extends EasterItemTool implements ITextureProvider
{
    ...
    protected EasterItemPickaxe(int par1, EasterToolMaterial par2EnumToolMaterial, int i)
    {
