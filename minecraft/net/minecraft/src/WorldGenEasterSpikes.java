...
public class WorldGenEasterSpikes extends WorldGenerator
{
    /**
    ...
    public WorldGenEasterSpikes(int par1)
    {
        this.replaceID = par1;
    }
...
//            par1World.spawnEntityInWorld(var13);
            par1World.setBlockWithNotify(par3, par4 + var6, par5, Block.netherrack.blockID);
            par1World.setBlockWithNotify(par3, par4 + var6, par5, Block.fire.blockID);
            return true;
        }
        else
        {
